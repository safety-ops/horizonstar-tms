-- Rollback: 20260507204200_submit_dealer_order_null_guards.down.sql
-- Reverts to the pre-guard body produced by 20260507204100_submit_dealer_order_rpc.sql.
-- Run this only if the null-guard migration needs to be reversed.
